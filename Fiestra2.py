...
from PyQt6.QtWidgets import (QApplication, QMainWindokw, QPushButton, QLabel, QLineEdit, QVBoxLayout, QWidget)


class NosaPrimeiraFiestra2(QMainWindow):
    def __init__(self, outraFiestra):
        super().__init__()
        ...
        btnSalida.clicked.connect(self.on_btnSaudo_clicked)




        btnSalida = QPushButton("Outra Fiestra")
